    ...
    <body>
        ...
        <div class="wrapper" style="background-color: #f0f0f0;">
            ...
            <nav id="sidebar" class="sammacmedia" style="background-color: #814096; border: 1px solid green">
                ...
                <li style="background-color: #000;">
                    ...
                    <li style="background-color: #eee; color: green;">
        ...
        <div class="panel-body">
                ...
                <tr>
                    ...
                    <?php
                                   $a=1;
                    $query=mysqli_query($mysqli,"select * from `message` ");
                     while($row=mysqli_fetch_array($query))
                        {
                          ...
                          <tr>
                            ...
                            <td>
                            <a  href="deletes.php?id=<?php echo $row['id']; ?>" class="btn btn-danger"><span class="fa fa-pencil" ></span>Delete</a> 
                              </td>
                          </tr>
                          <?php
