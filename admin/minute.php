...
<html lang="en">
    ...
    <body>
     ...
     <div class="panel panel-default sammacmedia">
         <div class="panel-heading">All Minutes</div>
     <div class="panel-body">
             ...
             <tr>
                 ...
                 <?php
                                $a=1;
                 $query=mysqli_query($mysqli,"select * from `main` ");
                  while($row=mysqli_fetch_array($query))
                     {
                       ...
                       <tr>
                           <td><?php echo $a;?></td> 
                         <td><?php echo $row['recordText'];?></td>
                         <td><?php echo $row['date'];?></td>  
                         <td><?php echo $row['time'];?></td>
                         <td>
                         <a href="delete.php?id=<?php echo $row['id']; ?>" data-toggle="modal" id="but" class="btn btn-danger"><span class="fa fa-times"></span> REMOVE</a> || 
                         <a href="edit.php?id=<?php echo $row['id']; ?>" data-toggle="modal" id="but" class="btn btn-warning"><span class="fa fa-pencil"></span> EDIT</a> ||  
                         <a href="view.php?id=<?php echo $row['id']; ?>" data-toggle="modal" id="but" class="btn btn-success"><span class="fa fa-print"></span> VIEW</a>   
                           </td>
                       </tr>
                       <?php
